...
const UserPrivacyPolicy = () => {
  const sections = [
    ...
    {
      subheading: "7.1 Healthcare Professionals (Doctors, Specialists, and Other Medical Professionals)",
      content: [
    ...
    {
      subheading: "7.3 Payment Processors",
      content: [
    ...
    {
      subheading: "7.4 Cloud Hosting and Platform Service Providers",
      content: [
    ...
    {
      subheading: "7.5 Analytics Providers",
      content: [
    ...
    {
      subheading: "7.6 Legal Authorities",
      content: [
    ...
    {
      subheading: "7.7 Limitations on Sharing",
      content: [
    ...
    {
      subheading: "8.1 Server Location",
      content: [
    ...
    {
      subheading: "8.2 Cross-Border Transfers",
      content: [
    ...
    {
      subheading: "8.3 Safeguards for International Data Transfers",
      content: [
    ...
    {
      subheading: "10.1 Right to Access",
      content: [
        ...
        [
          ...
          "Technical or usage data collected"
        ]
      ]
    },
    {
      ...
      content: [
        ...
        "This includes:",
        [
          "Account details (name, email, phone number, date of birth, gender)",
          "Profile information and preferences",
          "Health data provided by the user"
        ],
    ...
    {
      subheading: "10.4 Right to Withdraw Consent",
      content: [
    ...
    {
      subheading: "10.5 Right to Data Portability",
      content: [
    ...
    {
      subheading: "10.6 Right to Restrict Processing",
      content: [
    ...
    {
      subheading: "10.7 Right to Object",
      content: [
    ...
    {
      subheading: "10.8 Right to Lodge a Complaint with the Regulator",
      content: [
    ...
    {
      subheading: "10.9 Exercise of Rights",
      content: [
    ...
    {
      subheading: "10.10 Additional Notes",
      content: [
        ...
        [
          "Legal obligations (e.g., medical record retention, financial regulations)",
          "Platform operational requirements (e.g., backup retention, fraud prevention)"
        ]
      ]
    ...
    {
      "subheading": "11.1 User-Initiated Account Deletion",
      "content": [
        "Users can delete their account through the Platform settings or by contacting Aven Health support.",
        "Upon account deletion:",
        [
          "All Personal Data, Health Data, account preferences, messages, journals, goals, managed conditions, and community content linked to the account are permanently deleted from Aven Health systems.",
          "Encrypted Health Data, messages, and appointments are removed from active storage.",
          "Users’ posts in anonymous mode are retained anonymously if still relevant for community integrity, with no link to the deleted account."
        ]
      ]
    },
    {
      "subheading": "11.2 Data Retained for Legal or Compliance Reasons",
      "content": [
        ...
        [
          "Medical or health records that are legally required to be retained under healthcare regulations",
          "Financial or transaction records required for tax, auditing, or anti-fraud compliance",
          "System logs or anonymized metadata necessary to maintain security, prevent fraud, or comply with legal obligations"
        ],
    ...
    {
      "subheading": "11.3 Timeline for Deletion",
      "content": [
    ...
    {
      "subheading": "11.4 User Rights After Deletion",
      "content": [
    ...
    {
      "subheading": "11.5 Transparency and Trust",
      "content": [
    ...
    {
      "subheading": "12.2 Access Controls",
      "content": [
    ...
    {
      "subheading": "12.3 Secure Servers and Infrastructure",
      "content": [
    ...
    {
      "subheading": "12.4 Authentication Safeguards",
      "content": [
    ...
    {
      "subheading": "12.5 Risk Acknowledgment",
      "content": [
    ...
    {
      "heading": "14. Community Content & Public Information",
      "content": [
    ...
    {
      "subheading": "14.1 Thoughts (Posts)",
      "content": [
    ...
    },
    {
      ...
      "content": [
        ...
        "To join a community:",
        [
          "Users submit a request to join.",
          "Community administrators approve membership."
        ],
    ...
    {
      "subheading": "14.3 Medical Stores and Products",
      "content": [
    ...
    {
      "subheading": "14.4 Healthcare Professionals",
      "content": [
        "Recommendations for healthcare professionals:",
        [
          "Are based on service type, professional category, and user gender",
          "Are randomized and intended for user convenience",
          "Do not constitute promotion or advertisement, in compliance with Kenya’s anti-advertisement regulations for medical professionals",
          "Users are free to select any professional regardless of recommendations."
        ],
        "The Platform does not influence medical decisions or compel users to engage with recommended professionals."
      ]
    },
    {
      "subheading": "14.5 Integrated Recommendation System",
      "content": [
    ...
    {
      "subheading": "14.6 User Responsibility",
      "content": [
        "Users are responsible for:",
        [
          "Content they post publicly",
          "Interactions in communities",
          "Compliance with Kenyan laws and regulations, including anti-discrimination and anti-advertisement laws"
        ],
