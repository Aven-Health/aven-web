      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-16 grid gap-12 md:grid-cols-6">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li>
              <Link to="/community-feed" className="hover:text-accent transition-colors">
                Communities
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li>
              <Link to="/doctors" className="hover:text-accent transition-colors">
                Book Appointments
              </Link>
            </li>
            <li>
              <Link to="/pharmacies" className="hover:text-accent transition-colors">
                Health Stores
              </Link>
            </li>
            <li>
       ...
       <div className="md:col-span-3 grid gap-12 md:grid-cols-3 text-sm text-gray-300">
          ...
          <div className="md:pr-6 md:border- md:border-white/10">
            ...
            <ul className={`${openSection === "users" ? "block" : "hidden"} md:block space-y-`}>
              <li>
                <Link to="/privacy-policy-users" className="hover:text-accent transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/user-agreement" className="hover:text-accent transition-colors">
                  User Agreement
                </Link>
              </li>
            </ul>
          ...
          <div className="md:px-0  md:border-white/10">
            ...
            <ul className={`${openSection === "pharmacies" ? "block" : "hidden"} md:block space-y-2`}>
              <li>
                <Link to="/privacy-policy-pharmacy" className="hover:text-accent transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
...
>
  Pharmacy Agreement
          ...
          <div className="md:pl-0">
            ...
            <ul className={`${openSection === "medical" ? "block" : "hidden"} md:block space-y-2`}>
              <li>
                <Link to="/privacy-policy-medical" className="hover:text-accent transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
